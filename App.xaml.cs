...
namespace TP2
{
    ...
    public partial class App : Application
    {
        ...
        {
            {1, new User(){FirstName="Tom",LastName="Richards", MailAddress="TomRichards@gmail.com",Password="trichards",ProfilePicture="user1.jpg"} },
            {2, new User(){FirstName="Elliot",LastName="Hart", MailAddress="ElliotHart@gmail.com",Password="ehart",ProfilePicture="user2.jpg"} },
            {3, new User(){FirstName="Rachel",LastName="Chapman", MailAddress="RachelChapman@gmail.com",Password="rchapman",ProfilePicture="user3.jpg"} },
            {4, new User(){FirstName="Myriam",LastName="Leblanc", MailAddress="MyriamLeblanc@gmail.com",Password="mleblanc",ProfilePicture="user4.jpg"} },
            {5, new User(){FirstName="Paul",LastName="Burnham", MailAddress="PaulBurnham@gmail.com",Password="pburnham",ProfilePicture="user5.jpg"} },
        };
